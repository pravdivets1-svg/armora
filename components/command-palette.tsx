  ...
  return (
    <>
      ...
      <button
        ...
        className="hidden md:inline-flex items-center gap-2 w-72 lg:w-80
      ...
      <button
        type="button"
        onClick={() => setOpen(true)}
        className="md:hidden p-2 rounded-md text-ink-500 hover:text-ink-900 hover:bg-ink-900/[0.06]"
        aria-label="Поиск"
      >
        <Search size={16} />
      </button>
